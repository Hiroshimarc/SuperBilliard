...
public class BalleStructure extends StackPane {
     ...
     * 
     * @param positionInitialeX Position initiale en X à attribuer à la BalleStructure
     */
    ...
    /**Mutateur de la position initiale en X de la BalleStructure
     * 
     * @param positionInitialeY Position initiale en Y à attribuer à la BalleStructure
     */
     ...
     */
    public BalleStructure(Balle balle){
    ...
    public boolean[] collisionsTable(Table table){ //Remplacer pane par table
        ...
        boolean atRightBorder = this.getLayoutX() >= ((limits.getMaxX())-20 - this.balle.getRadius());
        boolean atLeftBorder = this.getLayoutX() <= (limits.getMinX()+20 + this.balle.getRadius());
        boolean atBottomBorder = this.getLayoutY() >= ((limits.getMaxY()-20)- this.balle.getRadius());
        boolean atTopBorder = this.getLayoutY() <= (limits.getMinY()+20 + this.balle.getRadius());
