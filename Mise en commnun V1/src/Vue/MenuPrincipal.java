...
public class MenuPrincipal {
    ...
    public MenuPrincipal(Stage stage) {
        ...
        boutonJouer.setOnAction((ActionEvent e) -> {
            ...
            menuJouer.table = new Table(10, 10, 1000, 500, Color.GREEN, Color.BROWN, Color.rgb(128, 0, 0));
            menuJouer.balle = new Balle(15, Color.WHITE, menuJouer.table.getWidth() / 2, menuJouer.table.getHeight() / 2);
            ...
            menuJouer.balle.launch(menuJouer.balle, menuJouer.balle.angleDeTir(angle), vitesse, menuJouer.table);
        });
